...
> [!ABSTRACT]
> A1 is currently in **v1.5.0 (Beta)**. This document outlines the trajectory towards v2.0 and beyond, focusing on eliminating cloud dependencies and enhancing agentic capabilities.
...
| **v1.4** | ✅ | Siri-Style GUI Overlay (Tauri v2) |
| **v1.5** | ✅ | **Complete System Control** (40+ commands): Weather, Bluetooth, Media, Screenshots, Night Mode, Cleanup, Timer, Power Profiles |
