...
### 🔹 [[Skills/Skill_Overview|Skills & Integrations]]
Action modules and external integrations.
- [[Skills/Skill_App_Control.md|App Control]]
- [[Skills/Skill_Arch_Linux.md|Arch Linux]]
- [[Skills/Skill_Web_Search.md|Web Search]]
- [[Skills/Skill_Weather.md|🌤️ Weather (Open-Meteo)]] **NEW!**
...
| **System Control** | 🟢 Local | 40+ commands (`systemctl`, `pactl`, `nmcli`, etc.) |
| **Weather** | 🟢 Free API | `Open-Meteo` (No key needed) |
